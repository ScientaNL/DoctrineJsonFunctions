...
class JsonContainsTest extends MysqlTestCase
{
    public function testJsonContains()
    {
        $this->assertDqlProducesSql(
            "SELECT JSON_CONTAINS('{\"a\": 1, \"b\": 2, \"c\": {\"d\": 4}}', '1', '$.a') from Syslogic\DoctrineJsonFunctions\Tests\Entities\Blank b",
    ...
    {
        $this->assertDqlProducesSql(
            "SELECT j.jsonData FROM Syslogic\DoctrineJsonFunctions\Tests\Entities\JsonData j WHERE JSON_CONTAINS(j.jsonData, :value, '$.papers[*].quality') = 1",
